...
<div class="row">
    <div class="col-xs-11 col-md-12">
           ...
           <div class="col-sm-8"><a style="text-decoration: none; color: inherit;" href="#">
                          ...
                          <img src="../../resources/table_icons/icons8-file-elements-64.png">       File management</a></div>
                  <!-- seach div -->
          ...
          <button name="NoFilter_x" value="1" id="NoFilter_x" type="submit" onClick="document.myform.SelectedID.value = ''; document.myform.NoDV.value=1; return true;"  class="btn btn-default" title="Show All">
            ...
            <div id="top_buttons" class="hidden-print">
                <div class="btn-group btn-group-lg visible-md visible-lg all_records pull-left">
                    <a href="addfile.php" style=" border-radius: 10px;width: 160%; margin-bottom: 20px;" type="submit" id="addNew" name="addnew" class="btn btn-success">Register new file</a>
...
<th class="patients-first_name" >REF NUMBER</a></th>
	<th class="patients-first_name" >FILE NAME</a></th>
        <th class="patients-first_name" >TYPE OF FILE</a></th>
          <th class="patients-first_name" >VOLUME OF FILE</a></th>
        <th class="patients-first_name" >CURRENT FOLLIO</a></th>
          <th class="patients-first_name" >MANAGE FILE</a></th>
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['edition']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['follio'];?></a></td>
<td id="patients-last_name-1177" class="patients-last_name">
    <form method="post" action="editfile.php">
        ...
        <input class="btn btn-warning" type="submit" name="checkfile" value="checkout file"></td>
...
<?php
$sql2= $conn->query("select * from files");
...
<tbody><!-- tv data below -->
<tr>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['ref_number']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['holder']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['type']; ?> </a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['edition'] ?></a></td>


<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['follio'];?></a></td>
<td id="patients-last_name-1177" class="patients-last_name">
    <form method="post" action="editfile.php">
        <input type="hidden" name="hiddenfile" value="<?php echo $row1['ref_number'];?>"> 
        <input class="btn btn-warning" type="submit" name="checkfile" value="checkout file"></td>
