...
<div class="row">
    <div class="col-xs-11 col-md-12">
           ...
           <div class="col-sm-8"><a style="text-decoration: none; color: inherit;" href="#">
                   ...
                   <img style=" height:80px;" src="../../resources/table_icons/request.png">file request</a></div>
                  <!-- seach div -->
          ...
          <button name="NoFilter_x" value="1" id="NoFilter_x" type="submit" onClick="document.myform.SelectedID.value = ''; document.myform.NoDV.value=1; return true;"  class="btn btn-default" title="Show All">
            ...
            <div id="top_buttons" class="hidden-print">
                <div class="btn-group btn-group-lg visible-md visible-lg all_records pull-left">
                    <a  style="text-decoration: none; border:solid green 1px; padding: 10px; border-radius: 5px;"style="position: relative; left:0%;" class="navbar-osition: relative;brand" href="request.php">
                        <font color="green" size="+1"><i class="glyphicon glyphicon-share"></i> make a new request</font></a>
                        
                        <a  style="text-decoration: none; border:solid green 1px; padding: 10px; border-radius: 5px;"style="position: relative; left:0%;" class="navbar-osition: relative;brand" href="index.php">
                        <font color="green" size="+1"><i class="glyphicon glyphicon-transfer"></i> incoming requests</font></a>
...
<?php
            ...
            $query= mysqli_query($conn,"select * from  requests where requests.ref_number ='$searchstring'and requests.source_dept='$session' and requests.status!='cancelled' ");
  ...
  ?>
      ...
      <table class="table table-striped table-bordered table-hover">
          ...
          <thead>
              <tr>
                  <th colspan="8"style="text-align: center;"><font color="red" size="+1">my sent requests</font></th>  
              </tr>
	...
	<th class="patients-first_name" >FILE NAME</a></th>
        <th class="patients-first_name" >REQUESTING DEPARTMENT</a></th>
        <th class="patients-first_name" >REQUESTING STAFF</a></th>
        <th class="patients-first_name" >DATE OF REQUEST</a></th>
        <th class="patients-first_name" >STATUS</a></th>
         <th class="patients-first_name" >CANCEL STATUS </a></th>
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['file_name']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['source_dept']; ?> </a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['source_position']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['request_date'];?></a></td>

<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php  echo $row['status'];?></a></td>

      
      <td>
       
          <form method="post" action="requestprocess.php">
        <input type="hidden" name="hiddenfile" value="<?php echo $row['ref_number'] ?>">
         <?php if($row['status']==="approved"){?>     
             <input type="submit" class="btn btn-warning" name="cancel" value="cancel request" disabled="">
         <?php } else { ?>
             <input type="submit" class="btn btn-warning" name="cancel" value="cancel request" >
...
<!-- tv data above -->
	...
	<th class="patients-first_name" >FILE NAME</a></th>
        ...
        <th class="patients-first_name" >Cancel request</a></th>
...
<tfoot>
	...
	<th class="patients-first_name" >REF NUMBER</a></th>
	<th class="patients-first_name" >FILE NAME</a></th>
        <th class="patients-first_name" >REQUESTING T0</a></th>
        <th class="patients-first_name" >REQUESTING STAFF</a></th>
        <th class="patients-first_name" >DATE OF REQUEST</a></th>
        <th class="patients-first_name" >&nbsp;&nbsp;STATUS &nbsp;&nbsp;&nbsp;</a></th>
...
<?php
$sql2= $conn->query("select * from requests where  source_dept  ='$session' and requests.status!='cancelled' order by status asc ");
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['ref_number']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['file_name']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['target_dept']; ?> </a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['target_position']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['request_date'];?></a></td>
...
<tfoot>
    <tr><td colspan=11>
            <div class="alert alert-warning" style="">
                <i class="glyphicon glyphicon-warning-sign"></i> you have not made any requests</div>
        </td></tr></tfoot>
              </table>
