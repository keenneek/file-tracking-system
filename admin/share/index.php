...
<div class="row">
    <div class="col-xs-11 col-md-12">
           ...
           <div class="col-sm-8"><a style="text-decoration: none; color: inherit;" href="#">
                   ...
                   <img style=" height:80px;" src="../../resources/table_icons/share.png"> file sharing</a></div>
                  <!-- seach div -->
                          <form enctype="multipart/form-data" method="get" name="myform" action="">
                        <div class="col-sm-4"><div class="input-group" id="quick-search">
                                <input type="text" name="searchstring" value="" class="form-control" placeholder="Search File By Reference NO">
                                <span class="input-group-btn">
                                    
                                    <input name="search"  id="Search" type="submit"  class="btn btn-default" title="Quick Search">
                                        <i class="glyphicon glyphicon-search"></i>
                                
                                        <button style="display: block;"name="NoFilter_x" value="1" id="NoFilter_x" type="submit" onClick="document.myform.SelectedID.value = ''; document.myform.NoDV.value=1; return true;"  class="btn btn-default" title="Show All">
            ...
            <div id="top_buttons" class="hidden-print">
                <div class="btn-group btn-group-lg visible-md visible-lg all_records pull-left">
                    <a class="navbar-brand" href="sharefile.php"><font color="green"><i class="glyphicon glyphicon-th"></i> share a file</a></font>
...
<?php
            ...
            $query= mysqli_query($conn,"select * from  sharing where sharing.ref_number ='$searchstring' and sharing.status ='0' and department !='$department'");
  ...
  ?>
      ...
      <table class="table table-striped table-bordered table-hover">
          <thead>
              ...
              <tr><td colspan="7"style="text-align: center;"><font size="+1" color="red"> shared files </font></td></tr>
	...
	<th class="patients-first_name" >DEPARTMENT</a></th>
        ...
        <th class="patients-first_name" >DATE OF SHARING</a></th>
        <th class="patients-first_name" >STATUS</a></th>
         <th class="patients-first_name" >APPROVE RETURN</a></th>
...
<tbody><!-- tv data below -->
<tr>
    <td style="text-align:" id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['ref_number']; ?></a></td>
     <td style="text-align:" id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['file_name']; ?></a></td>
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['date'];?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo "not returned"; ?></a></td>

<td>
    <form method="post" action="editfile.php">
        <input type="hidden" name="hiddenuser" value="<?php echo $id; ?>">
        <input type="hidden" name="hiddenfile" value="<?php echo $row['ref_number'];?>"> 
        <input type="submit" name="checkfile" class="btn btn-warning" value="approve return"></td>
...
<?php
$sql2= $conn->query("select * from sharing where sharing.status = '0' and department !='$department' ");
