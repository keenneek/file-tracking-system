...
<div class="row">
    <div class="col-xs-11 col-md-12">
           ...
           <div class="col-sm-8"><a style="text-decoration: none; color: inherit;" href="#">
                   ...
                   <img src="../../resources/table_icons/download.png" style="height: 100px;">    user management</a></div>
                  <!-- seach div -->
                          <form enctype="multipart/form-data" method="get" name="myform" action="">
                        <div class="col-sm-4"><div class="input-group" id="quick-search">
                                <input autocomplete="off" type="text" name="searchstring" value="" class="form-control" placeholder="Search department">
...
<?php
            ...
            $query= mysqli_query($conn,"select * from  users where users.department ='$searchstring'");
  ...
  ?>
      ...
      <table class="table table-striped table-bordered table-hover"><thead><tr>
         <th class="patients-first_name" >USER ID</a></th>                                                      
	<th class="patients-first_name" >USENMAME</a></th>
	<th class="patients-first_name" >DEPARTMENT</a></th>
        <th class="patients-first_name" >POSITION</a></th>
      
          <th class="patients-first_name" >MANAGE USER  </a></th>
...
<tbody><!-- tv data below -->
<tr>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['id']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['username']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['department']; ?> </a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['position']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name">
    <form method="post" action="user.php">
        <input type="hidden" name="hiddenid" value="<?php echo $row['id'];?>"> 
        <input class="btn btn-warning" type="submit" name="checkuser" value="manage user"></td>
...
<tfoot>
    <tr><td colspan=11>
            <div class="alert alert-warning">
                <i class="glyphicon glyphicon-warning-sign"></i> No such users found!</div>
        </td></tr></tfoot>
              </table>
              <?php
                }
...
<?php
$sql2= $conn->query("select * from users  ");
...
<tr>
<tr>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['id']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['username']; ?></a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['department']; ?> </a></td>
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row1['position']; ?></a></td>

<td id="patients-last_name-1177" class="patients-last_name">
    <form method="post" action="user.php">
        <input type="hidden" name="hiddenid" value="<?php echo $row1['id'];?>"> 
        <input class="btn btn-warning" type="submit" name="checkuser" value="manage user"></td>
...
<tfoot>
    <tr><td colspan=11>
            <div class="alert alert-warning" style="">
                <i class="glyphicon glyphicon-warning-sign"></i> file database is null</div>
        </td></tr></tfoot>
              </table>
