...
//get file from homeSS
 ...
 <?php
    ...
    <div class="row"><div class="col-xs-11 col-md-12">
            <form enctype="multipart/form-data" method="post" name="myform" action="deleteuser.php">
    ...
    <div class="panel-body" id="patients_dv_container">
            ...
            <div class="row">
                    ...
                    <div class="col-md-8 col-lg-10" id="patients_dv_form">
                        <?php
                         $query1= $conn->query("select * from users where users.id='$file'");
                         ...
                         ?>
                            <fieldset class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                            <label for="last_name" class="control-label col-lg-3">ID<span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <input readonly maxlength="40" type="text" class="form-control" name="refno" id="refn" value="<?php echo $row1['id'];?>" required>
                                            </div>
                                    </div>

                                    <div class="form-group">
                                            <label for="first_name" class="control-label col-lg-3"> User Name<span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <input readonly maxlength="40" type="text" class="form-control" name="fileholder" id="fileholder" value="<?php echo $row1['username'];?>" required>
                                            </div>
                                    </div>
                                
                                 <div class="form-group">
                                            <label for="first_name" class="control-label col-lg-3">Department<span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <input readonly maxlength="40" type="text" class="form-control" name="fileholder" id="fileholder" value="<?php echo $row1['department'];?>" required>
                                            </div>
                                    </div>
                                
                                 <div class="form-group">
                                            <label for="first_name" class="control-label col-lg-3"> position<span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <input readonly maxlength="40" type="text" class="form-control" name="fileholder" id="fileholder" value="<?php echo $row1['position'];?>" required>
                                            </div>
                                    </div>
                    ...
                    <input  type="submit" class="btn btn-danger" id="insert" name="delete" value=" delete User">
