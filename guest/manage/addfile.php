    ...
    <div class="row"><div class="col-xs-11 col-md-12">
            <form enctype="multipart/form-data" method="post" name="myform" action="registerprocess.php">
    ...
    <div class="panel-body" id="patients_dv_container">
                    ...
                    <div class="col-md-8 col-lg-10" id="patients_dv_form">
                            <fieldset class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                    <input maxlength="40" type="text" class="form-control" name="fileholder" id="fileholder" value="" required>
                                            </div>
                                    </div>
            ...
            <option value="ADMINISRATION" >ADMINISTRATION</option>
...
//THIS IS THE SELECT SCRIPT
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                    <input maxlength="40" type="text" class="form-control" name="follio" id="mobile" value="">
                                            </div>
                                    </div>

                                <input type="hidden" name="hiddenid" value="<?php echo $_SESSION['user'] ?>">
                                    <div class="form-group">
                                            <label for="mobile" class="control-label col-lg-3">File Volume</label>
                                            <div class="col-lg-9">
                                                    <input maxlength="40" type="text" class="form-control" name="fileedition" id="mobile" value="">
                                            </div>
                                    </div>
                    ...
                    <div class="col-md-4 col-lg-2" id="patients_dv_action_buttons">
                            <div class="btn-toolbar">
                                    ...
                                    <div class="btn-group-vertical btn-group-lg" style="width: 100%;">
                                            <button type="submit" class="btn btn-success" id="insert" name="submit" value="1" onclick="return patients_validateData();">
