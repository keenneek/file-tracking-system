          ...
          <button name="NoFilter_x" value="1" id="NoFilter_x" type="submit" onClick="document.myform.SelectedID.value = ''; document.myform.NoDV.value=1; return true;"  class="btn btn-default" title="Show All">
            ...
            <div id="top_buttons" class="hidden-print">
                <div class="btn-group btn-group-lg visible-md visible-lg all_records pull-left">
                    <a  style="text-decoration: none; border:solid green 1px; padding: 10px; border-radius: 5px;"style="position: relative; left:0%;" class="navbar-osition: relative;brand" href="myrequests.php"><font color="green" size="+1"><i class="glyphicon glyphicon-th"></i>  go to my requests</font></a>
...
<?php
            ...
            $query= mysqli_query($conn,"select * from  requests where requests.ref_number ='$searchstring' and target_dept ='$session' and status ='pending'");
  ...
  ?>
	...
	<th class="patients-first_name" >FILE NAME</a></th>
        ...
        <th class="patients-first_name" >APPROVE</a></th>
       
        <th class="patients-first_name" >DECLINE</a></th>
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo $row['status'];?></a></td>
      ...
      <td>
        ...
        <input type="submit" class="btn btn-success" name="approve" value="approve request">
      </td>
      <td>
         
        
        <input type="submit" class="btn btn-warning" name="decline" value="decline request">
      </td>
...
<?php
$sql2= $conn->query("select * from requests where target_dept ='$session' and status ='pending' ");
...
<td id="patients-last_name-1177" class="patients-last_name"><a  style="display: block; padding:0px; text-decoration: none;"><?php echo "<font color='black'>"; echo $row['status']; echo "</font>";?></a></td>
...
<tfoot>
    <tr><td colspan=11>
            <div class="alert alert-warning" style="">
                <i class="glyphicon glyphicon-warning-sign"></i> you have 0 incoming file requests</div>
        </td></tr></tfoot>
              </table>
