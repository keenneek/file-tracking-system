...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div style="height: 60px; margin: -15px 0 -45px; background-position-x:250px;background-position-y:-250px;">
							</div>
	...
	<div class="col-sm-6 col-lg-8" id="login_splash">
		<!-- custLLPLomized splash content here -->
              
	</div>
                                                    <br><br><br>                                    
        <div class="col-sm-6 col-lg-4"  style="width:40%; position:absolute; left:60%; top:0em;">
		<div class="panel panel-success">

			<div class="panel-heading">
				<h1 class="panel-title"><strong>register Here</strong></h1>
				...
				<form method="post" action="controllers/register.php">
					<div class="form-group">
						...
						<label class="control-label" for="username">department</label>
                                                <select   class="form-control" name="department" id="username">
                                                    <option style="background-color:beige; border: green solid 1px;" value="">select your department</option> 
                                                    <?php
						...
						<label class="control-label" for="username">position</label>
                                                <select  class="form-control" name="position" id="username">
                                                    <option value="">select our position </option>
					...
					<div class="form-group">
						<label class="control-label" for="password">Password</label>
                                    ...
                                    <div class="form-group">
                                        <font color="red" size="+1">passwords did not match</font>  
					</div>
                                       <?php }?>
                                    
                                    <div class="form-group">
						<label class="control-label" for="password"> confirm Password</label>
						<input autocomplete="off" class="form-control" name="password1" id="password" type="password" placeholder="Password" required>
                                                <span class="help-block">aready registerd? <a href="index.php">log in to your account</a></span>
					</div>
					...
					<div class="row">
						<div class="col-sm-offset-3 col-sm-6">
							<input name="signin" type="submit" id="submit" value="signIn" class="btn btn-primary btn-lg btn-block">
						</div>
					</div>
				</form>
			</div>
